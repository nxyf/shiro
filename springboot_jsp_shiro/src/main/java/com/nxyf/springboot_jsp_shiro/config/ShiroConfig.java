package com.nxyf.springboot_jsp_shiro.config;

import com.nxyf.springboot_jsp_shiro.shiro.cache.RedisCacheManage;
import com.nxyf.springboot_jsp_shiro.shiro.realms.CustomerRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager defaultWebSecurityManager){
        ...
        hashMap.put("/user/login.jsp", "anon");//公共资源，不需要认证
